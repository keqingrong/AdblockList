...
export ZSH=/Users/keqingrong/.oh-my-zsh
...
plugins=(git autojump urltools zsh-autosuggestions zsh-completions zsh-syntax-highlighting)
...
export PATH="$PATH:$HOME/.composer/vendor/bin" # Add Laravel to PATH
